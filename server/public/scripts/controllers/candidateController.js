...
eagleApp.controller('candidateController', ['$scope', '$location', '$http' ,'Admin', 'CandidateService', 'textAngularManager',
function($scope, $location, $http, Admin, CandidateService, textAngularManager) {
